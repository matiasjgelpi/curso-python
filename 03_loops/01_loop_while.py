...
print("\nEjercicio 3:")
# numeroIngresado = int(input("Ingresa un número entero positivo:"))
...
#   contrasena = input("Contrseña invalida, Ingresa una contraseña:")
# else:{
...
while multiplo <= 10:
  print(numeroIngresado * multiplo)
  multiplo += 1
...
while numeroActual >= 2:
    divisor = 2  # Reiniciar divisor para cada número
